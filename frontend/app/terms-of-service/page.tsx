    ...
    <>
      ...
      <Section>
        <div className="max-w-3xl mx-auto prose-custom">
          <p>
            These terms govern services provided by {company.name}. Engaging us for any service constitutes acceptance
            of these terms.
          </p>
          ...
          <p>
            ...
            unless stated otherwise. Changes to scope may change cost and timeline; we will confirm any such change
            with you before proceeding.
          </p>

          <h2>Project Agreements</h2>
          <p>
            Larger engagements are governed by a written agreement setting out scope, deliverables, timeline,
            acceptance criteria, and payment schedule. Where that agreement conflicts with these terms, the agreement
            prevails.
          </p>
          ...
          <p>
            You agree to provide timely access to information, systems, and personnel needed to deliver the work, and
            to hold appropriate licences for any software you ask us to install or configure. Delays in providing
          ...
          <p>
            ...
            that engagement. We are not liable for indirect or consequential loss, including loss of profit or data.
            You are responsible for maintaining your own backups; we will advise on backup strategy but cannot
            guarantee recovery of data that was not backed up.
          </p>

          <h2>Confidentiality</h2>
          <p>
            We treat client business information as confidential and do not disclose it to third parties except as
            needed to deliver the agreed services or as required by law.
          </p>
          ...
          <p>
            We may update these terms as our services change. The version in force at the time of your engagement
            applies to that engagement.
          </p>
