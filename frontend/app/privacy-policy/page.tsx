  ...
  return (
    <>
      ...
      <LegalPage updated="2026-09-16">
        ...
        <p>
          We collect only what you submit through our forms: your name, email address, phone number (optional), business
          name (optional), and the content of your message, quote request, or service request. If you subscribe to our
          newsletter, we store your email address.
        </p>
        ...
        <h2>Cookies</h2>
        <p>
          We use a first-party cookie to record your cookie-consent choice. Analytics cookies (Google Analytics 4) are
          loaded <strong>only if you accept</strong>. If you decline, analytics never loads. You can change your choice
          by clearing your cookies for this site.
        </p>

        <h2>Third Parties</h2>
        <p>
          Form submissions are stored on our application server and email notifications are delivered via
          <strong> Resend</strong>, a transactional email provider. If you accept cookies, usage analytics are processed
          by <strong>Google Analytics 4</strong>. These providers process data on our behalf under their own privacy
          terms.
        </p>

        <h2>Data Security</h2>
        <p>
          Submissions are transmitted over HTTPS and stored on access-controlled systems. Administrative access to lead
          data requires authentication and is restricted to authorised staff.
        </p>
        ...
        <p>
          ...
          may unsubscribe from our newsletter at any time. Contact us using the details below.
        </p>
        ...
        <p>We may update this policy as our services change. Material changes will be reflected on this page.</p>
